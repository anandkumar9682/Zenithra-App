...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    private final SolutionLibraryAccessors laccForSolutionLibraryAccessors = new SolutionLibraryAccessors(owner);
    ...
    /**
     * Group of libraries at <b>solution</b>
     */
    public SolutionLibraryAccessors getSolution() {
        return laccForSolutionLibraryAccessors;
    }
    ...
    public static class FaceLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>detection</b> with <b>com.google.mediapipe:face-detection</b> coordinates and
    ...
    public static class FirebaseLibraryAccessors extends SubDependencyFactory {
        ...
        private final FirebaseServiceLibraryAccessors laccForFirebaseServiceLibraryAccessors = new FirebaseServiceLibraryAccessors(owner);
        ...
        /**
         * Group of libraries at <b>firebase.service</b>
         */
        public FirebaseServiceLibraryAccessors getService() {
            return laccForFirebaseServiceLibraryAccessors;
        }
    ...
    public static class FirebaseAppcheckLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>firebaseInt</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
    ...
    public static class FirebaseServiceLibraryAccessors extends SubDependencyFactory {

        public FirebaseServiceLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
         ...
         */
        public Provider<MinimalExternalModuleDependency> getAuth() {
            return create("firebase.service.auth");
        }
    ...
    public static class GoogleFirebaseLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>firebaseDatabaseVersion</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getDatabase() {
    ...
    public static class SolutionLibraryAccessors extends SubDependencyFactory {

        public SolutionLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>core</b> with <b>com.google.mediapipe:solution-core</b> coordinates and
         * with version reference <b>solutionCore</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getCore() {
            return create("solution.core");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>appName</b> with value <b>Certify Factory</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>applicationId</b> with value <b>com.acviss.mercantile</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>faceDetection</b> with value <b>0.90.7</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>firebaseDatabaseVersion</b> with value <b>21.0.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getFirebaseDatabaseVersion() { return getVersion("firebaseDatabaseVersion"); }

        /**
         * Version alias <b>firebaseInt</b> with value <b>17.0.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getFirebaseInt() { return getVersion("firebaseInt"); }
        ...
        /**
         * Version alias <b>namespace</b> with value <b>com.acviss.mercantile</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>solutionCore</b> with value <b>0.90.7</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getSolutionCore() { return getVersion("solutionCore"); }
        ...
        /**
         * Version alias <b>versionCode</b> with value <b>18</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>versionName</b> with value <b>1.1.9</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
